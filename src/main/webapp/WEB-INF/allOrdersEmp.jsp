...
<html>
    ...
    <body>
        ...
        <form name="showUser" action="FrontController" method="POST">
            <input type="hidden" name="command" value="showUser">
            <input type="number" name="idu" placeholder="Order id" required/>            
            <input type="submit" value="Se information om en kunde"/>           
        </form>  
